...
subplot(1,2,1)
plt.plot(percent_weights_remaining, test_accuracies, 'o--')
...
subplot(1,2,2)
plt.plot(percent_weights_remaining, iter_history, 'o--')
plt.xlabel("Percentage of Weights Remaining")
plt.ylabel("Early Stopping Iterations")
plt.title('Epochs = %d' %num_epochs)
plt.grid()
plt.gca().invert_xaxis()

plt.savefig("prune_acc_iter.png")
